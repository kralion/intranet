...
const GrubloFooter = () => {
  return (
    <div className="flex w-full flex-col items-center justify-between gap-5 border-t border-gray-900/5 p-10  dark:border-white/5 sm:flex-row">
      <p className="text-xs text-gray-600 dark:text-gray-400">
        Copyright © {new Date().getFullYear()}{" "}
        <a href="https://mkycorp.netlify.app" className="underline">
          Grublo Inc
        </a>{" "}
      </p>
      <div className="flex gap-4">
        ...
        <SocialLink href="https://github.com/mky-corp" icon={GitHubIcon}>
          Síguenos en GitHub
        </SocialLink>
        <SocialLink
          href="https://discord.com/channels/1221221595998195802/1222322006914105545"
          icon={DiscordIcon}
        >
          Ingresa a nuestor server en Discord
        </SocialLink>
      </div>
    </div>
  );
